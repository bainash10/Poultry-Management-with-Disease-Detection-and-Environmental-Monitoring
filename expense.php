...
if (isset($_GET['update'])) {
  ...
  $edit_state = true;
  $query = "SELECT * FROM `expense_entry` WHERE id = '$update_id'";
...
if (isset($_POST['update-expense'])) {
  ...
  $sql = "UPDATE `expense_entry` SET  type='$type', amount='$amount', date='$date', comments='$comments' WHERE id=$update_id";
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-xl-6 col-lg-7">
              <div class="card">
                <div class="card-header">Expense Entry</div>
                <div class="card-body">
                  <div class="form">
                    <form method="post">
                      ...
                      <div class="row">
                        <div class="col-xl-6">
                          <div class="form-group">
                            ...
                            <select name="type" class="form-control">
                              ...
                              <?php
                              $query = "SELECT * FROM `expense` ORDER BY type ASC";
                        ...
                        <div class="col-xl-6">
                          <div class="form-group">
                            <label>Amount</label>
                            <input type="number" name="amount" class="form-control" required="" value="<?php echo $u_amount; ?>">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-xl-6">
                          <div class="form-group">
                            ...
                            <textarea name="comments" class="form-control"><?php echo $u_comments; ?></textarea>
                          </div>
                        </div>
                      </div>
                      <?php if ($edit_state == false) {?>
                      <input type="submit" name="expense-entry" value="Add Record" class="btn btn-secondary float-right">
                     <?php } else {?> 
                      <input type="submit" name="update-expense" value="Update Record" class="btn btn-success float-right">
                     <?php } ?>
                    </form>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="form">
                    <form method="post">
                      ...
                      <input type="submit" name="add-expense" value="Add" class="btn btn-secondary">
                    </form>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="responsive-table">
                    <table id="expenses" class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                        $query = "SELECT * FROM `expense_entry` WHERE name_idd = '$comp_name' ORDER BY id DESC";
                        $fetch = $mysqli->query($query) or die($mysqli->error.__LINE__);
                        while($row = $fetch->fetch_assoc()){ ?>
                          <tr>
                            ...
                            <td>
                              <a href="expense.php?update=<?php echo $row['id']; ?>" class="btn btn-success">Update</a>
                              <a href="database/delete.php?delete_expense_record=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
