...
if (isset($_GET['update'])) {
  ...
  $edit_state = true;
  $query = "SELECT * FROM `suppliers` WHERE id = '$update_id'";
...
if (isset($_POST['update-supplier'])) {
  ...
  $sql = "UPDATE `suppliers` SET  name='$name', telephone='$telephone', city='$city', state='$state', country='$country', address='$address' WHERE id=$update_id";
        ...
        <div class="container-fluid">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-6">
                      <div class="form-group">
                        <label>City</label>
                        <input type="text" name="city" class="form-control" required="" value="<?php echo $u_city; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-xl-6">
                      <div class="form-group">
                        <label>State</label>
                        <input type="text" name="state" class="form-control" required="" value="<?php echo $u_state; ?>">
                      </div>
                    </div>
                    <div class="col-xl-6">
                      <div class="form-group">
                        <label>Country</label>
                        <input type="text" name="country" class="form-control" required="" value="<?php echo $u_country; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <?php if ($edit_state == false) {?>
                      <input type="submit" name="add-supplier" value="Add Supplier" class="btn btn-secondary float-right">
                     <?php } else {?> 
                      <input type="submit" name="update-supplier" value="Update Supplier" class="btn btn-success float-right">
                     <?php } ?>
                    </form>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-xl-12 col-lg-7">
              <div class="card">
                <div class="card-header" id="suppliers">All Suppliers</div>
                <div class="card-body">
                  <div class="responsive-table">
                    <table id="chicken" class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                      $query = "SELECT * FROM `suppliers` WHERE name_idd = '$comp_name' ORDER BY id DESC";
                      ...
                      while($row = $fetch->fetch_assoc()){ ?>
                        <tr>
                          ...
                          <td>
                            <a href="distributor.php?update=<?php echo $row['id']; ?>" class="btn btn-success">Update</a>
                            <a href="database/delete.php?delete_supplier=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                          </td>
                        </tr>
                      <?php } ?>
                      </tbody>
