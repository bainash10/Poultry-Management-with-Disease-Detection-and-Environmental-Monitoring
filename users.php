...
if (isset($_POST['update-user'])) {
  ...
  $sql = "UPDATE `accounts` SET  u_name='$u_name', telephone='$telephone', email='$email', password='$password', address='$address', type='$type' WHERE id=$update_id";
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form">
                    <form method="post">
                      ...
                      <div class="form-group">
                        <label>Name</label>
                    <div class="form-group">
                      <input type="text" name="u_name" class="form-control" required="" value="<?php echo $u_u_name; ?>">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-xl-6">
                    ...
                    <div class="col-xl-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control" required="" value="<?php echo $u_email; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <?php if ($edit_state == false) {?>
                      <input type="submit" name="register" value="Add user" class="btn btn-secondary float-right">
                     <?php } else {?> 
                      <input type="submit" name="update-user" value="Update user" class="btn btn-success float-right">
                     <?php } ?>
                    </form>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="responsive-table">
                    <table id="chicken" class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                      $query = "SELECT * FROM `accounts` WHERE name = '$comp_name' ORDER BY id ASC";
                      ...
                      while($row = $fetch->fetch_assoc()){ ?>
                        <tr>
                          ...
                          <td>
                            <a href="users.php?update=<?php echo $row['id']; ?>" class="btn btn-success">Update</a>
                            <a href="database/delete.php?delete_user=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                          </td>
                        </tr>
                      <?php } ?>
                      </tbody>
