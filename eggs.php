...
if (isset($_GET['update'])) {
  ...
  $edit_state = true;
  $query = "SELECT * FROM `egg_sale` WHERE id = '$update_id' ORDER BY id ASC";
  ...
  $u_t_trays = $data['t_trays'];
  $u_date = $data['date'];
}

if (isset($_POST['update-sale'])) {
  ...
  $sql = "UPDATE `egg_sale` SET  customer='$customer', paid='$paid', l_no='$l_no', u_price='$u_price', t_trays='$t_trays', t_amount='$t_amount', date='$date' WHERE id=$update_id";
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-xl-5 col-lg-7">
              <div class="card">
                <div class="card-header">Egg Tray Sales</div>
                <div class="card-body">
                  <div class="form">
                    <form method="post">
                      ...
                      <div class="form-group">
                        ...
                        <select name="customer" class="form-control">
                          <option><?php echo $u_customer; ?></option>
                          <?php
                      ...
                      <div class="row">
                        <div class="col-xl-6">
                          <div class="form-group">
                            ...
                            <input type="number" name="t_trays" class="form-control" required="" value="<?php echo $u_t_trays; ?>">
                          </div>
                        </div>
                        <div class="col-xl-6">
                          <div class="form-group">
                            <label>Paid</label>
                            <input type="number" name="paid" class="form-control" required="" value="<?php echo $u_paid; ?>">
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <?php if ($edit_state == false) {?>
                        <input type="submit" name="tray-sale" value="Add Record" class="btn btn-secondary">                      <?php } else {?> 
                        <input type="submit" name="update-sale" value="Update Record" class="btn btn-success">
                      <?php } ?>
            ...
            <div class="col-xl-4 col-lg-7">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p><b>Sold</b>: <?php echo $sold; ?> trays</p>

                  <?php
                  $query = "SELECT * FROM `egg_tray`";
                  $fetch = $mysqli->query($query) or die($mysqli->error.__LINE__);
                  $produced = 0;
                  while($row = $fetch->fetch_assoc()){ 
                    $produced += $row['tray'];
                  ...
                  <?php $available = $produced-$sold; ?>
                  <p><b>Available</b>: <?php echo $available; ?> trays</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-7">
              <div class="card">
                <div class="card-header">Add Egg trays</div>
                <div class="card-body">
                  <div class="form">
                    <form method="post">
                      <input type="hidden" name="name_idd" value="<?php echo $_SESSION['name']; ?>">
                      <div class="form-group">
                        ...
                        <input type="number" name="tray" class="form-control" required="">
                      </div>
                      <input type="submit" name="add-tray" value="Add" class="btn btn-secondary">
                    </form>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="responsive-table">
                    <table id="chicken" class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                        $query = "SELECT * FROM `egg_sale` ORDER BY id ASC";
                        $fetch = $mysqli->query($query) or die($mysqli->error.__LINE__);
                        while($row = $fetch->fetch_assoc()){ ?>
                          <tr>
                            <td><?php echo $row['date']; ?></td>
                            <td><a href="client.php?#clients"><?php echo $row['customer']; ?></a></td>
                            <td><?php echo $row['l_no']; ?></td>
                            <td><?php echo $row['t_trays']; ?></td>
                            <td>NRS. <?php echo $row['u_price']; ?></td>
                            <td>NRS. <?php echo $row['paid']; ?></td>
                            <td>NRS. <?php echo $row['t_amount']; ?></td>
                            <td>
                              <a href="eggs.php?update=<?php echo $row['id']; ?>" class="btn btn-success">Update</a>
                              <a href="database/delete.php?delete_egg_sale=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
